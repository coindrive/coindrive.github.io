...
.service('CreateWalletService', function (Storage, $rootScope, $modal) {

  function createWallet (lastVersion) {
    var $scope = $rootScope.$new();
    $scope.lastVersion = lastVersion;

    $modal.open({
      controller: 'WalletController',
      templateUrl: templateUrl('create_wallet'),
      scope: $scope,
      windowClass: 'create_wallet_window mobile_modal'
    });
  }
...
.service('AddUserService', function (Storage, $rootScope, $modal) {

  function addUserModal () {
    var $scope = $rootScope.$new();
    $modal.open({
      controller: 'WalletController',
      templateUrl: templateUrl('add_users'),
      windowClass: 'add_users_window mobile_modal'
    });
  }
...
.service('AddUserContactService', function (Storage, $rootScope, $modal) {

  function addUserContactModal () {
    var $scope = $rootScope.$new();
    $modal.open({
      controller: 'WalletController',
      templateUrl: templateUrl('add_users_contact'),
      windowClass: 'add_users_window mobile_modal'
    });
  }

  return {
    addUserContactModal: addUserContactModal
  }
})
.service('AcceptShareWalletService', function (Storage, $rootScope, $modal) {

  function AcceptShareWallet () {
    var $scope = $rootScope.$new();
    $modal.open({
      controller: 'WalletController',
      templateUrl: templateUrl('shareWallet'),
      windowClass: 'add_users_window mobile_modal'
    });
  }

  return {
    AcceptShareWallet: AcceptShareWallet
  }
})
.service('SendCoinService', function (Storage, $rootScope, $modal) {

  function sendCoin () {
    var $scope = $rootScope.$new();
    $modal.open({
      controller: 'WalletController',
      templateUrl: templateUrl('send_coin'),
      windowClass: 'send_coin_window mobile_modal'
    });
  }
...
.service('SendCoinChatWindowService', function (Storage, $rootScope, $modal) {

  function sendCoinChatWindow () {
    var $scope = $rootScope.$new();
    $modal.open({
      controller: 'WalletController',
      templateUrl: templateUrl('send_coin_chat_window'),
      windowClass: 'send_coin_window mobile_modal'
    });
  }

  return {
    sendCoinChatWindow: sendCoinChatWindow
  }
})
.service('SendCoinContactWindowService', function (Storage, $rootScope, $modal) {

  function sendCoinContactWindow () {
    var $scope = $rootScope.$new();
    $modal.open({
      controller: 'WalletController',
      templateUrl: templateUrl('send_coin_contact_window'),
      windowClass: 'send_coin_window mobile_modal'
    });
  }

  return {
    sendCoinContactWindow: sendCoinContactWindow
  }
})
.factory('BalanceWalletService', function($rootScope){
	return {
...
.filter('sameWallet', function(){
	return function(data, walletId){
		if(!data.length || !walletId) {
			return data;
		}
